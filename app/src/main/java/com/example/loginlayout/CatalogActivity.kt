...
/*
 * Pantalla de biblioteca del usuario.
 * Muestra los juegos comprados y permite entrar en el detalle de cada producto.
 */
class CatalogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gridAdapter = GameGridAdapter(this, purchased) { product ->
            val intent = Intent(this, ProductDetailActivity::class.java)

            intent.putExtra("productId", product.id)
            intent.putExtra("nombreJuego", product.title)
            intent.putExtra("categoriaJuego", product.category)
            intent.putExtra("descripcionJuego", product.description)
            intent.putExtra("precioJuego", product.price)
            intent.putExtra("imagenPath", product.imagePath)
    ...
    override fun onResume() {
        ...
        findViewById<BottomNavigationView>(R.id.bottomNav).selectedItemId = R.id.nav_library
    }
